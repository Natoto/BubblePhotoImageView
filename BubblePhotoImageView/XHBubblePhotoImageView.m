...
- (void)configureMessagePhoto:(UIImage *)messagePhoto thumbnailUrl:(NSString *)thumbnailUrl originPhotoUrl:(NSString *)originPhotoUrl onBubbleMessageType:(XHBubbleMessageType)bubbleMessageType {
    ...
    if (thumbnailUrl) {
        __block XHBubblePhotoImageView * weakSelf = self;
        [self addSubview:self.activityIndicatorView];
        [self.activityIndicatorView startAnimating];
//        self.messagePhoto = [UIImage imageNamed:@"placeholder"];
        UIImage * image = messagePhoto;
//        [imageview sd_setImageWithURL:[NSURL URLWithString:thumbnailUrl]  placeholderImage:messagePhoto completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
